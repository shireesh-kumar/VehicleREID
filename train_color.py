...
best_model_path = 'hsv_color_best_resnet34_type.pth'
...
plt.ylabel('Actual')
plt.savefig('hsv_color_confusion_matrix.png')  # Save confusion matrix as an image
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('hsv_color_loss_plot.png')  # Save loss plot as an image
plt.close()
...
plt.ylabel('Accuracy (%)')
plt.legend()
plt.savefig('hsv_color_accuracy_plot.png')  # Save accuracy plot as an image
plt.close()
